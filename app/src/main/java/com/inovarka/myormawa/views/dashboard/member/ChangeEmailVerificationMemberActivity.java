...
public class ChangeEmailVerificationMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setWhiteStatusBar();
        setContentView(R.layout.activity_change_email_verification_member);
    ...
    private void verifyCode() {
        ...
        // Create request - gunakan currentEmail untuk verifikasi
        VerifyOtpRequest request = new VerifyOtpRequest("verify_otp", currentEmail, code, "change_email");
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (apiResponse.isSuccess()) {
                        ...
                        updateEmailInPreferences(newEmail);
                        verifyCodeSuccess();
                    } else {
                        Toast.makeText(ChangeEmailVerificationMemberActivity.this,
    ...
    private void updateEmailInPreferences(String email) {
    ...
    private void verifyCodeSuccess() {
        progressLoading.setVisibility(View.GONE);
        Intent intent = new Intent(this, ChangeEmailSuccessMemberActivity.class);
    ...
    private void handleResend() {
        // Create request dengan new_email untuk change_email resend
        ResendOtpRequest request = new ResendOtpRequest("resend_otp", currentEmail, "change_email", newEmail);
