...
public class ChangePasswordOldMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setStatusBar();
        setContentView(R.layout.activity_change_password_old_member);
            ...
            public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (loginResponse.isSuccess()) {
                        // Password benar, lanjut ke ChangePasswordNewMemberActivity
                        Intent intent = new Intent(ChangePasswordOldMemberActivity.this, ChangePasswordNewMemberActivity.class);
                        ...
                        if (remainingAttempts > 0) {
                            ...
                            Toast.makeText(ChangePasswordOldMemberActivity.this,
