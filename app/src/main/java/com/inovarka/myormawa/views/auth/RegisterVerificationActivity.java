...
public class RegisterVerificationActivity extends AppCompatActivity {
    ...
    private void verifyCode() {
        ...
        // Create request
        VerifyOtpRequest request = new VerifyOtpRequest("verify_otp", email, code, "register");
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (apiResponse.isSuccess()) {
                        ...
                        Toast.makeText(RegisterVerificationActivity.this,
    ...
    private void handleResend() {
        // Create request
        ResendOtpRequest request = new ResendOtpRequest("resend_otp", email, "register");
