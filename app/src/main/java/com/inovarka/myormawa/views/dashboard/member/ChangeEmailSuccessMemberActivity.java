...
public class ChangeEmailSuccessMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_email_success_member);

        // Get email baru dari ChangeEmailVerificationMemberActivity
        updatedEmail = getIntent().getStringExtra("email");
    ...
    private void initViews() {
        ...
        btnContinue.setOnClickListener(v -> navigateBackToProfile());
    }
    ...
    private void navigateBackToProfile() {
        btnContinue.animate()
                ...
                .withEndAction(() -> btnContinue.animate()
                        ...
                        .setDuration(100)
                        .withEndAction(() -> {
                            // Kembali ke halaman sebelumnya (Profile/Dashboard)
                            // Tutup semua activity change email dan kembali
                            finish();
                        })
                        .start())
                .start();
