...
public class DataPribadiMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupStatusBar();
        setContentView(R.layout.activity_data_pribadi_member);
    ...
    private void setupStatusBar() {
        ...
        getWindow().getDecorView().setSystemUiVisibility(0); // Dark status bar
    }
    ...
    private void initViews() {
        ...
        edtDepartemen = findViewById(R.id.edt_departemen);
    ...
    private void loadUserData() {
        ...
        String email = prefs.getString(Constants.KEY_EMAIL, "e41242025@student.polije.ac.id");
        ...
        edtDepartemen.setText(departemen);
